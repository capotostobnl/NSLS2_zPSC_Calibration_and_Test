...
int main() {
    const char *target_ip = "10.69.26.55";
    ...
    FastSetpoint pairs[] = {
        { .address = 0x0, .setpoint = 11.50000f },
        { .address = 0x1, .setpoint = 11.50001f },
        { .address = 0x2, .setpoint = 11.50002f },
        { .address = 0x3, .setpoint = 11.50003f },    
    };

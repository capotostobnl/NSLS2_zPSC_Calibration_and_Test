...
\begin{figure}[htbp]
	...
	\begin{tikzpicture}[
		...
		\node[node] (fofb2) at (-6,4.8) {PSC FOFB \#2\\IP Address: xxx};
		...
		\node[node] (fofb1) at (6,0) {PSC FOFB \#1\\IP Address: xxx};
		...
		% DIRECT CONNECTION
		% ======================
		\draw[line, dashed, red, thick] (fofb2) -- (workstation);
		
		\node[red, font=\small, align=center]
		at ($(fofb2)!0.5!(workstation) + (2.6,0.4)$)
		{Direct connection\\FOFB \#2 $\leftrightarrow$ Workstation};
